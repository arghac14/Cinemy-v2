   ...
   <div id="header">
    ...
    <Form ref="formCustom" :model="formCustom" :rules="ruleCustom" :label-width="80">
        ...
        <FormItem label="Admin?">
            <i-switch v-model="formCustom.switch" size="large">
                <span slot="open"></span>
    ...
    <hr><br>
    <div class="yellow-text">Already have an account? <a href="/login">Sign in</a></div>
</div>
</center>
</template>
<script>
                ...
                this.$refs[name].validate((valid) => {
                    if (valid) {
                        var requestData = {
                            ...
                            isAdmin: this.formCustom.switch
                        }
                        userAPIService
                        .add(requestData)
                        .then((res)=>{
                            if(res){
                                ...
                                this.$Message.error('User already exists with given username or password!');
                            }
                        })
                        .catch((e)=>{
                            console.log(e);
