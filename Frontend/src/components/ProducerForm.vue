    ...
    <div class="producer-form">
     <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
        <FormItem required label="Name:" prop="name">
            <Input v-model="formValidate.name" placeholder="Enter director's Name..."></Input>
        </FormItem>
        ...
        <FormItem>
            <Button id="sm-button" type="primary" @click="producerFormSubmit('formValidate')" long>Submit</Button>
        </FormItem>
    </Form>   
    </div>
</template>
...
import { mapActions } from "vuex";
    export default {
        ...
        methods: {
            ...mapActions(["getAllProducers"]),
            producerFormSubmit (data) {
